    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li class="active">
                    <a  href="index.php?controle=Etudiant&action=accueil" ><i class="fas fa-home"></i> Accueil</a>
                </li>
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu">
                        <li>
                            <a href="index.php?controle=contact&action=liste_contacts">Camarade de classe</a>
                        </li>
                        <li>
                ...
                <li>
                    <a href="index.php?controle=Etudiant&action=edt"><i class="fas fa-calendar-alt"></i> Emploie du temps</a>
                </li>
                <li>
                
                    <a  href="index.php?controle=Etudiant&action=modifProfiletu"><i class="fas fa-cog"></i> Paramètres</a>
                </li>
            </ul>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <li class="nav-item active">
                                <a class="nav-link" href="index.php?controle=Etudiant&action=bye"><i class="fas fa-sign-out-alt"></i> Deconnexion</a>
                            </li>
                        </ul>
                    </div>
