...
<html>
	<head>
		<meta charset="utf-8">
		<title>Modifier le Profil professeure</title>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script>
	...
	<body>
		...
		<br><br><h1>Modifier le Profil professeur</h1>	
			<form action="index.php?controle=Gerant&action=modifProfilprof " method="post">
				<br>
    			<!--<input type="file" name="fileToUpload" id="fileToUpload"><br>-->
 				<br> Nom:<br>
  				<input name="nom" id="nom" class="form-control" value="<?php echo $nom; ?>">
  				<br> Prenom:<br>
  				<input name="prenom" id="prenom" class="form-control" value="<?php echo $prenom; ?>">
  				<br> Email:<br>
  				<input name="email" id="email" class="form-control" value="<?php echo $email; ?>">
  				<br> Login:<br>
  				<input name="login_prof" id="login_prof" class="form-control" value="<?php echo $login_prof; ?>">
  				<br> Mot de passe:<br>
  				<input name="pass_prof" id="pass_prof" class="form-control" value="<?php echo $pass_prof; ?>">
  				<br><br>
