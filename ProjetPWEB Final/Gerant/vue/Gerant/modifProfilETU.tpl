...
<html>
	<head>
		<meta charset="utf-8">
		<title>Modif Profil professeur</title>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script>
	...
	<body>
		...
		<br><br><h1>Modifier le profil d'un étudiant</h1>	
			<form action="index.php?controle=Gerant&action=modifProfiletudiant " method="post">
				<br>
    			<!--<input type="file" name="fileToUpload" id="fileToUpload"><br>-->
 				<br> Nom:<br>
  				...
  				<br> Login:<br>
  				<input name="login_etu" id="login_etu" class="form-control" value="<?php echo $login_etu; ?>">
  				<br> Mot de passe:<br>
  				<input name="pass_etu" id="pass_etu" class="form-control" value="<?php echo $pass_etu; ?>">
  				<br><br>
